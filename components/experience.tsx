...
const experiences: ExperienceItem[] = [
  {
    ...
    description:
      "Built AI-powered document parsing features for a web application, focusing on structured extraction, frontend performance, testing, and product reliability",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "Built a diversity engagement platform within SAP Build, contributing across frontend logic, data modeling, API integration, and technical presentation",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "Led software development for a competitive robotics team, building control systems, computer vision, and autonomous robot functionality while managing a 12-person programming team",
    responsibilities: [
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-gray-300">
            My professional journey as a developer. Click on each card to see
            more details.
          </p>
        </motion.div>
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {exp.technologies.map((tech, i) => (
                                <span
                                  key={i}
                                  className="bg-zinc-700 px-3 py-1 rounded-full text-xs"
                                >
                                  {tech}
                                </span>
                              ))}
